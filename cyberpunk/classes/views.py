...
from .models import Class, ClassLevel, SubClassLevel
...
class ClassDetailView(generic.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # sub_class_features = set()
        # for level in sub_class_levels:
        #     sub_class_features.update(level.class_feature.all())
        ...
        # context['sub_class_features'] = sub_class_features
